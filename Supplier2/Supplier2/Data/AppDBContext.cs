...
namespace Supplier2.Data
{
    public class AppDBContext : DbContext
    {
        ...
        {
            var conn = "Data Source=PANDULA_ASUS;Initial Catalog=Supplier2;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False";
